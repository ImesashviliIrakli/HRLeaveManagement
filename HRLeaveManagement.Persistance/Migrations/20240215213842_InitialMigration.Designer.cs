...
namespace HRLeaveManagement.Persistance.Migrations
{
    ...
    [Migration("20240215213842_InitialMigration")]
            ...
            modelBuilder.Entity("HRLeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 2, 16, 1, 38, 41, 596, DateTimeKind.Local).AddTicks(661),
                            DateModified = new DateTime(2024, 2, 16, 1, 38, 41, 596, DateTimeKind.Local).AddTicks(672),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
